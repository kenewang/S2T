...
const HSResults = ({
  ...
  return (
    <div className="h-results-container">
      {searchResults.map((file) => (
        <div key={file.id} className="h-result-item">
          <div className="h-result-file-icon">
            <img
              src={file_icon}
              alt="file_icon"
          ...
          <div className="h-file-info">
            <p className="h-file-title">{file.fileName}</p>
